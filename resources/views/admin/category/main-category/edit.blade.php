            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('maincategory.update', $mainCategory->id) }}"
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label for="exampleInputUsername1" class="form-label">Main Category Name:</label>
                            <input type="text" name="main_category_name" value="{{ $mainCategory->main_category_name }}"
                        ...
                        <div class="form-group mt-2" style="margin-bottom: 100px">
                            ...
                            <div class="d-flex" style=" max-width: 100px; height: 50px;">
                                ...
                                <img id="imagePreview" src="{{ asset('storage/' . $mainCategory->image) }}"
                                    alt="Image Preview"
                                    style="display: {{ $mainCategory->image ? 'block' : 'none' }}; margin-top: 10px; max-width: 350px; height: 100px;" />
                            </div>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <select class="form-control" name="status" id="categoryStatus" >
                                <option value="active" {{ $mainCategory->status == 'active' ? 'selected' : '' }}>Active
                                </option>
                                <option value="inactive" {{ $mainCategory->status == 'inactive' ? 'selected' : '' }}>
                                    Inactive</option>
                            </select>
                        </div>
