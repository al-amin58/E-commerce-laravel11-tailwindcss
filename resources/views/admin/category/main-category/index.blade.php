...
@section('content')
    <nav class="page-breadcrumb flex justify-between">
        ...
        <button type="button" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0" data-toggle="modal"
            data-target="#addMainCategoryModal"> Add Main Category</button>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Main Category Table</h6>
                            ...
                            <tbody>
                                @foreach ($mainCategroes as $mainCategroy)
                                    <tr>
                                        ...
                                        <td>{{ $mainCategroy->main_category_name }}</td>
                                        <!-- Ensure you are using the correct property -->
                                        <td>
                                            <img src="{{ asset('storage/' . $mainCategroy->icon) }}" alt=""
                                                srcset="" style="max-width: 200px; height: auto;">
                                        </td>
                                        <td>
                                            <img src="{{ asset('storage/' . $mainCategroy->image) }}" alt=""
                                                srcset="" style="max-width: 200px; height: auto;">
                                        </td>
                                        <td>{{ $mainCategroy->status }}</td>
                                        <td>
                                            <div class="flex gap-2">
                                                <a href="{{ route('admin.EditMaincategory', $mainCategroy->id) }}" class="btn"><i class="me-1 icon-md" data-feather="edit"
                                                        style="color: green"></i></a>
                                                <button id="deleteButton" class="btn" data-toggle="modal"
                                                    data-target="#deleteModal" data-id="{{ $mainCategroy->id }}">
                ...
                <form action="{{ route('maincategory.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="main_category_name" class="form-control inputbgtextcolor"
