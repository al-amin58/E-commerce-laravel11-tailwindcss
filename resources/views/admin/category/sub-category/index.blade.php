            ...
            <div class="card" id="modal-input">
                <div class="card-header border-bottom flex justify-content-between">
                    ...
                    <div class="text-center py-4">
                        <a class="btn btn-primary" data-bs-target="#modalInput" data-bs-toggle="modal" href="javascript:void(0)">Add Sub Category </a>
                    </div>
                </div>
                <div class="mx-5">
                            ...
                            <div class="table-responsive">
                                <table id="tasks-table" class="table text-nowrap mb-0 table-bordered border-top border-bottom">
                                    ...
                                    <tr>
                                        ...
                                        <th class="bg-transparent border-bottom-0">Main Category</th>
                                    ...
                                    @foreach ($subCategories as $subCategory)
                                        <tr>
                                            ...
                                            <td class="text-muted fs-15 fw-semibold">{{ $subCategory->mainCategory->main_category_name }}</td>
                                            <td class="text-muted fs-15 fw-semibold">{{ $subCategory->Sub_category_name }}</td>
                                            <td class="text-muted fs-15 fw-semibold">
                                                <img src="{{ asset('storage/' . $subCategory->icon) }}" alt="" srcset="" style="max-width: 50px; height: auto;">
                                            </td>
                                            <td class="text-muted fs-15 fw-semibold">
                                                <img src="{{ asset('storage/' . $subCategory->image) }}" alt=""
                                                     srcset="" style="max-width: 50px; height: auto;">
                                            </td>
                                            <td class="{{ $subCategory->status === 'inactive' ? 'text-danger' : 'text-primary' }} fs-15 fw-semibold">{{ $subCategory->status }}</td>
                                            <td>
                                                <div class="d-flex align-items-stretch justify-content-center">
                                                    <a href="{{ route('admin.Editsubcategory', $subCategory->id) }}" class="btn btn-sm btn-outline-primary border me-2"  data-bs-original-title="Edit">
                                                        <i class="fe fe-edit-2"></i>
                                                    </a>
                                                    <button id="deleteButton" data-id="{{ $subCategory->id }}" data-toggle="modal" data-target="#deleteModal" class="btn btn-sm btn-outline-secondary border "  data-bs-original-title="Delete">
                ...
                <form action="{{ route('subcategory.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label text-muted">Sub Category Name:</label>
                            <div class="input-group">
                                <input type="text" name="Sub_category_name" class="form-control" placeholder="Enter Sub Category Name" required>
                            </div>
                        </div>
                        <div class="form-group mt-2">
                            <label for="maincategory" class="form-label text-muted" >Main Category:</label>
