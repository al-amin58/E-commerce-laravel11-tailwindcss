      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 col-12">
          <div class="content-left">
            <img src="{{ asset('website-assets') }}/assets/images/about/about-img.jpg" alt="#">
            <a href="https://www.youtube.com/watch?v=r44RKWyfcFw&amp;fbclid=IwAR21beSJORalzmzokxDRcGfkZA1AtRTE__l5N4r09HcGS5Y6vOluyouM9EM"
              class="glightbox video"><i class="lni lni-play" style="margin-top: 35%"></i></a>
          </div>
        </div>
        <div class="col-lg-6 col-md-12 col-12">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 col-12">
          ...
          <div class="single-team">
            <div class="image">
              <img src="{{ asset('website-assets') }}/assets/images/team/01.jpg" alt="#">
            </div>
            <div class="content">
              <div class="info">
                <h3>Grace Wright</h3>
        ...
        <div class="col-lg-3 col-md-6 col-12">
          ...
          <div class="single-team">
            <div class="image">
              <img src="{{ asset('website-assets') }}/assets/images/team/02.jpg" alt="#">
            </div>
            <div class="content">
              <div class="info">
        ...
        <div class="col-lg-3 col-md-6 col-12">
          ...
          <div class="single-team">
            <div class="image">
              <img src="{{ asset('website-assets') }}/assets/images/team/03.jpg" alt="#">
            </div>
            <div class="content">
              <div class="info">
                <h3>Quinton Cross</h3>
        ...
        <div class="col-lg-3 col-md-6 col-12">
          ...
          <div class="single-team">
            <div class="image">
              <img src="{{ asset('website-assets') }}/assets/images/team/04.jpg" alt="#">
            </div>
            <div class="content">
              <div class="info">
                <h3>Liana Mullen</h3>
