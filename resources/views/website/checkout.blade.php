                                                ...
                                                <div class="payment-option-wrapper">
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-1">
                                                            <img src="{{ asset('website-assets') }}/assets/images/shipping/shipping-1.png"
                                                                alt="Sipping">
                                                    ...
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-2">
                                                            <img src="{{ asset('website-assets') }}/assets/images/shipping/shipping-2.png"
                                                                alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    ...
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-3">
                                                            <img src="{{ asset('website-assets') }}/assets/images/shipping/shipping-3.png"
                                                                alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    ...
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-4">
                                                            <img src="{{ asset('website-assets') }}/assets/images/shipping/shipping-4.png"
                                                                alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="mt-5">
                                                ...
                                                <label for="cash" style="font-size: 16px; font-weight: 700">Cash
                                                    payment</label>
                                            </div>
                                            <div class="mt-2">
                                                <input id="bank" type="radio" name="payment" value="bank">
                                                <label for="bank" style="font-size: 16px; font-weight: 700">Bank
                                                    payment</label>
                                            </div>
                                        </div>
                                        <div class="col-8">
                                            <div class="checkout-payment-form">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        ...
                                                        <img src="{{ asset('website-assets') }}/assets/images/payment/card.png"
                                                            alt="card">
                                                    </div>
                                                </div>
                    ...
                    <div class="checkout-sidebar">
                        ...
                        <div class="checkout-sidebar-banner mt-30">
                            <a href="product-grids.html">
                                <img src="{{ asset('website-assets') }}/assets/images/banner/banner.jpg" alt="#">
                            </a>
                        </div>
                    </div>
                </div>
